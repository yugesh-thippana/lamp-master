...
?>
    ...
    <a href="request.php" class="btn btn-warning"> REQUESTS</a>
    <a href="playlist.php" class="btn btn-info"> MY PLAYLIST</a>
    <a href="reset-password.php" class="btn btn-primary float-right"> Reset Password</a>
            ...
            <td> 
                ...
                */
                ...
                <?php
                    if ($temp == false): 
                ?>    
                    <a href="process.php?playlist=<?php echo $row['id']; ?>"
                        class="btn btn-primary">ADD TO Playlist</a>
                <?php else : ?>
                    <a href="process.php?unplaylist=<?php echo $row['id']; ?>"
